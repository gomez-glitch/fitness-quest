...
export const MOTIONS = {
  ...
  "knee-ups": {
    view: "side", duration: 1800, poster: 0,
    base: { ...SIDE_BASE, y: 74, torso: 2, a1: [12, 10], a2: [16, 12] },
    frames: [
      { t: 0, l1: [78, 92, 0], l2: [-4, 6, 0] },
      { t: 0.5, l1: [-4, 6, 0], l2: [78, 92, 0] },
      { t: 1, l1: [78, 92, 0], l2: [-4, 6, 0] },
    ],
  },

  "hip-circles": {
    view: "front", duration: 2000, poster: 0,
    base: { ...FRONT_BASE, a1: [32, -68], a2: [32, -68], l1: [10, 1, 0], l2: [10, 1, 0] },
    frames: [
      { t: 0, x: 55, y: 75, torso: 6 },
      { t: 0.25, x: 60, y: 73, torso: 0 },
      { t: 0.5, x: 65, y: 75, torso: -6 },
      { t: 0.75, x: 60, y: 77, torso: 0 },
      { t: 1, x: 55, y: 75, torso: 6 },
    ],
  },

  "sky-reach": {
    view: "front", duration: 2800, poster: 0.5,
    base: { ...FRONT_BASE },
    frames: [
      { t: 0, y: 75, a1: [10, 4], a2: [10, 4] },
      { t: 0.5, y: 71, a1: [172, 4], a2: [172, 4] },
      { t: 1, y: 75, a1: [10, 4], a2: [10, 4] },
    ],
  },

  "dead-bugs": {
    view: "side", duration: 2400, poster: 0,
    base: { ...SIDE_BASE, x: 58, y: 96, torso: -88, neck: 20 },
    frames: [
      { t: 0, a1: [-135, 6], a2: [-176, 4], l1: [112, 100, 0], l2: [95, 12, 20] },
      { t: 0.5, a1: [-176, 4], a2: [-135, 6], l1: [95, 12, 20], l2: [112, 100, 0] },
      { t: 1, a1: [-135, 6], a2: [-176, 4], l1: [112, 100, 0], l2: [95, 12, 20] },
    ],
  },
  ...
  "butt-kicks": {
    ...
    base: { ...SIDE_BASE, y: 74, torso: 6, neck: -4 },
    frames: [
      { t: 0, l1: [-10, 135, 0], l2: [2, 10, 10], a1: [-26, 60], a2: [30, 60] },
      { t: 0.5, l1: [2, 10, 10], l2: [-10, 135, 0], a1: [30, 60], a2: [-26, 60] },
      { t: 1, l1: [-10, 135, 0], l2: [2, 10, 10], a1: [-26, 60], a2: [30, 60] },
    ],
  },

  "lateral-raises": {
    view: "front", duration: 2200, poster: 0.5, weights: true,
    base: { ...FRONT_BASE },
    frames: [
      { t: 0, a1: [12, 6], a2: [12, 6] },
      { t: 0.5, a1: [92, 4], a2: [92, 4] },
      { t: 1, a1: [12, 6], a2: [12, 6] },
    ],
  },
  ...
  "bent-over-rows": {
    view: "side", duration: 2200, poster: 0.5, weights: true,
    base: {
      ...SIDE_BASE, y: 79, torso: 52, neck: -26,
      l1: [4, 18, 0], l2: [7, 21, 0],
    },
    frames: [
      { t: 0, a1: [4, 6], a2: [8, 8] },
      { t: 0.5, a1: [-34, 92], a2: [-30, 88] },
      { t: 1, a1: [4, 6], a2: [8, 8] },
    ],
  },

  "farmer-hold": {
    view: "side", duration: 2400, poster: 0.5, weights: true,
    base: { ...SIDE_BASE, torso: 0, a1: [4, 3], a2: [7, 5], l1: [1, 2, 0], l2: [3, 4, 0] },
    frames: [
      { t: 0, y: 75, neck: 0 },
      { t: 0.5, y: 76.2, neck: 4 },
      { t: 1, y: 75, neck: 0 },
  ...
  "jump-lunges": {
    view: "side", duration: 900, poster: 0,
    base: { ...SIDE_BASE, torso: 8, neck: -4 },
    frames: [
      { t: 0, y: 76, l1: [34, 14, 0], l2: [-34, 42, -40], a1: [-30, 55], a2: [34, 55] },
      { t: 0.25, y: 69, l1: [2, 12, 0], l2: [-2, 12, 0], a1: [4, 40], a2: [4, 40] },
      { t: 0.5, y: 76, l1: [-34, 42, -40], l2: [34, 14, 0], a1: [34, 55], a2: [-30, 55] },
      { t: 0.75, y: 69, l1: [2, 12, 0], l2: [-2, 12, 0], a1: [4, 40], a2: [4, 40] },
      { t: 1, y: 76, l1: [34, 14, 0], l2: [-34, 42, -40], a1: [-30, 55], a2: [34, 55] },
    ],
  },
  ...
  // --- animal moves pack: prowl, hop, scuttle, waddle, zoom ---

  "bunny-hops": {
    view: "front", duration: 700, poster: 0.4, face: "happy",
    base: { ...FRONT_BASE, a1: [30, 115], a2: [30, 115] },
    frames: [
      { t: 0, y: 76, l1: [8, 10, 0], l2: [8, 10, 0], torso: 0 },
      { t: 0.4, y: 70, l1: [10, 4, 0], l2: [10, 4, 0], torso: -2 },
      { t: 0.7, y: 76.5, l1: [10, 14, 0], l2: [10, 14, 0], torso: 1 },
      { t: 1, y: 76, l1: [8, 10, 0], l2: [8, 10, 0], torso: 0 },
    ],
  },

  "bear-crawl": {
    view: "side", duration: 1400, poster: 0.25,
    base: { ...SIDE_BASE, y: 89, torso: 58, neck: -34 },
    frames: [
      { t: 0, x: 56, a1: [30, 4], a2: [14, 4], l1: [-46, 34, -40], l2: [-16, 14, -20] },
      { t: 0.5, x: 60, a1: [14, 4], a2: [30, 4], l1: [-16, 14, -20], l2: [-46, 34, -40] },
      { t: 1, x: 56, a1: [30, 4], a2: [14, 4], l1: [-46, 34, -40], l2: [-16, 14, -20] },
    ],
  },

  "crab-walk": {
    view: "side", duration: 1400, poster: 0.25,
    base: { ...SIDE_BASE, y: 85, torso: -72, neck: 58 },
    frames: [
      { t: 0, x: 56, a1: [-15, 4], a2: [-20, 3], l1: [58, 85, 0], l2: [40, 70, -25] },
      { t: 0.5, x: 60, a1: [-20, 3], a2: [-15, 4], l1: [40, 70, -25], l2: [58, 85, 0] },
      { t: 1, x: 56, a1: [-15, 4], a2: [-20, 3], l1: [58, 85, 0], l2: [40, 70, -25] },
    ],
  },

  "frog-hops": {
    view: "side", duration: 1200, poster: 0,
    base: { ...SIDE_BASE, neck: -14 },
    frames: [
      { t: 0, x: 56, y: 92, torso: 38, a1: [22, 6], a2: [28, 8], l1: [78, 118, 0], l2: [74, 114, 0] },
      { t: 0.2, x: 55, y: 94, torso: 42, a1: [18, 4], a2: [24, 6], l1: [84, 124, 0], l2: [80, 120, 0] },
      { t: 0.5, x: 62, y: 64, torso: 8, a1: [75, 10], a2: [82, 12], l1: [28, 42, -20], l2: [24, 38, -20] },
      { t: 0.75, x: 58, y: 90, torso: 34, a1: [26, 8], a2: [32, 10], l1: [74, 112, 0], l2: [70, 108, 0] },
      { t: 1, x: 56, y: 92, torso: 38, a1: [22, 6], a2: [28, 8], l1: [78, 118, 0], l2: [74, 114, 0] },
    ],
  },

  "inchworm": {
    view: "side", duration: 3600, poster: 0.5,
    base: { ...SIDE_BASE },
    frames: [
      { t: 0, x: 60, y: 75, torso: 3, neck: 0, a1: [12, 6], a2: [16, 8], l1: [1, 3, 0], l2: [3, 5, 0] },
      { t: 0.22, x: 60, y: 80, torso: 92, neck: -30, a1: [55, 4], a2: [60, 5], l1: [-4, 8, -20], l2: [-2, 6, -20] },
      { t: 0.5, x: 54, y: 89, torso: 80, neck: -24, a1: [14, 4], a2: [18, 5], l1: [-92, 4, -78], l2: [-95, 5, -78] },
      { t: 0.78, x: 60, y: 80, torso: 92, neck: -30, a1: [55, 4], a2: [60, 5], l1: [-4, 8, -20], l2: [-2, 6, -20] },
      { t: 1, x: 60, y: 75, torso: 3, neck: 0, a1: [12, 6], a2: [16, 8], l1: [1, 3, 0], l2: [3, 5, 0] },
    ],
  },

  "duck-waddle": {
    view: "side", duration: 1300, poster: 0.25,
    base: {
      ...SIDE_BASE, y: 93, neck: -8,
      a1: [-38, 70], a2: [-44, 74],
    },
    frames: [
      { t: 0, x: 57, torso: 8, l1: [86, 128, 0], l2: [64, 108, -25] },
      { t: 0.5, x: 61, torso: 16, l1: [64, 108, -25], l2: [86, 128, 0] },
      { t: 1, x: 57, torso: 8, l1: [86, 128, 0], l2: [64, 108, -25] },
    ],
  },

  "cheetah-sprint": {
    view: "side", duration: 450, poster: 0.25, face: "happy",
    base: { ...SIDE_BASE, torso: 20, neck: -10 },
    frames: [
      { t: 0, y: 73, a1: [55, 95], a2: [-40, 80], l1: [68, 105, 0], l2: [-38, 55, -30] },
      { t: 0.5, y: 71.5, a1: [-40, 80], a2: [55, 95], l1: [-38, 55, -30], l2: [68, 105, 0] },
      { t: 1, y: 73, a1: [55, 95], a2: [-40, 80], l1: [68, 105, 0], l2: [-38, 55, -30] },
    ],
  },

  "kangaroo-jumps": {
    view: "side", duration: 1000, poster: 0.45, face: "happy",
    base: { ...SIDE_BASE, a1: [42, 100], a2: [48, 104], neck: -8 },
    frames: [
      { t: 0, x: 58, y: 84, torso: 26, l1: [58, 96, 0], l2: [54, 92, 0] },
      { t: 0.45, x: 62, y: 58, torso: 4, l1: [14, 28, -35], l2: [10, 24, -35] },
      { t: 0.72, x: 58, y: 84, torso: 24, l1: [56, 94, 0], l2: [52, 90, 0] },
      { t: 1, x: 58, y: 84, torso: 26, l1: [58, 96, 0], l2: [54, 92, 0] },
    ],
  },
  ...
  "burpees": {
    ...
    base: { ...SIDE_BASE },
    frames: [
      { t: 0, y: 75, torso: 3, neck: 0, a1: [10, 8], a2: [14, 10], l1: [1, 3, 0], l2: [3, 5, 0] },
      { t: 0.18, y: 88, torso: 48, neck: -22, a1: [28, 6], a2: [32, 8], l1: [80, 108, 0], l2: [77, 105, 0] },
      { t: 0.42, y: 86, torso: 78, neck: 4, a1: [-4, 8], a2: [-8, 10], l1: [-94, 4, -55], l2: [-97, 6, -55] },
      { t: 0.66, y: 88, torso: 48, neck: -22, a1: [28, 6], a2: [32, 8], l1: [80, 108, 0], l2: [77, 105, 0] },
      { t: 0.85, y: 66, torso: -4, neck: 6, a1: [-160, 6], a2: [-154, 8], l1: [-4, 10, 20], l2: [0, 12, 20] },
      { t: 1, y: 75, torso: 3, neck: 0, a1: [10, 8], a2: [14, 10], l1: [1, 3, 0], l2: [3, 5, 0] },
    ],
  },
};
